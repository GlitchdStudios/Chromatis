#if UNITY_WEBPLAYER
#pragma warning disable 0414	// DragDecalsImage is used on non-stupid platform targets ;)
#endif
...
#region CONST
	...
	const string QD_DATABASE_PATH = "Assets/ProCore/QuickDecals/Resources/QuickDecalsDatabase.asset";
...
#region Decal Placement
	...
	bool PlaceDecal(Vector2 mousePosition, Material mat, Rect uvCoordinates, float rotation, float scale, out GameObject decal, out Transform hitTransform)
	{
		...
		if(nearest == null || nearest.GetComponent<MeshFilter>() == null) return false;

		Mesh msh = nearest.GetComponent<MeshFilter>().sharedMesh;
